...
<%-- 	var msg=null;
 ...
 function evtfile(){
  //alert("in evtfile")
   var spectrum=document.getElementById("spectrum").value;
var response=document.getElementById("response").value;
var evtbindata=document.getElementById("evtbindata").value;
var badpixbindata=document.getElementById("badpixbindata").value;
 

  if  (spectrum==null || spectrum=="",response==null || response=="",evtbindata==null || evtbindata=="",badpixbindata==null ||badpixbindata=="")
{
	  ...
	  if (evtbindata==null || evtbindata=="")
      {
	    	document.getElementById("3").classList.toggle("has-error");

          
      }
	  if (badpixbindata==null || badpixbindata=="")
      {
	...
	//alert(expires);
	 document.cookie = "response="+ response+ ";" + expires + ";path=/";
 ...
 function serverFileOpen(checkboxName)
 {
     ...
     for (var i=0; i<checkboxes.length; i++) 
     {
         if (checkboxes[i].checked) 
         {
              ...
              if((fname.indexOf("level2_quad_clean_Q0.pha") !== -1)||(fname.indexOf("level2_quad_clean_Q1.pha") !== -1)||(fname.indexOf("level2_quad_clean_Q2.pha") !== -1)||(fname.indexOf("level2_quad_clean_Q3.pha") !== -1)||(fname.indexOf("level2_quad_clean.evt") !== -1)|| (fname.indexOf("level2_quad_badpix.fits") !== -1))
            	  {
            	  

            	  if((fname.indexOf("level2_quad_clean_Q0.pha") !== -1)||(fname.indexOf("level2_quad_clean_Q1.pha") !== -1)||(fname.indexOf("level2_quad_clean_Q2.pha") !== -1)||(fname.indexOf("level2_quad_clean_Q3.pha") !== -1))
             	 {
             	 document.getElementById("spectrum").value=fname;
             	 }
              if(fname.indexOf("level2_quad_clean.evt") !== -1)
         	 {
             	 document.getElementById("evtbindata").value=fname;
         	 }
              if(fname.indexOf("level2_quad_badpix.fits") !== -1)
         	 {
             	 document.getElementById("badpixbindata").value=fname;
         	 }
                  }
              	else
            	  {
...
var evtbindata=document.getElementById("evtbindata").value;
//var badpixbindata=document.getElementById("badpixbindata").value;
var m = document.getElementById("badpixbindata").selectedIndex;
var badpixbindata=(document.getElementsByTagName("option")[m].value);
alert(badpixbindata);
			 ...
			 if(serverClick == "true")
				{
					...
					var url="/Pipeline/cztrspgen?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
				}else{
					
					var url="/Pipeline/cztrspgen?&localClicked="+localClicked+"&serverClick="+serverClick; 
					//var url="/Pipeline/cztbunchclean?&localClicked="+localClicked; 
				}
//var url="/Pipeline/cztrspgen?&submit="+submit;  
...
function display()
{
    ...
    if (req.readyState == 4 && req.status == 200)
    {
        ...
        alert("cztrspigen COMPLETED SUCCESSFULLY");
...
function processModule()
{
	...
	if (msg == "cztrspigen.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
	...
	<%-- var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztrspigen...!")
	 {
...
document.getElementById("spectrum").value="";
	...
	document.getElementById("evtbindata").value="";
	document.getElementById("badpixbindata").value="";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 13-CZTRSPIGEN </h4>
                        ...
                        <div class="card">
                            <form class="form-horizontal" name="form1"  action="/Pipeline/html/ltr/uplod.jsp" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Input spectrum file</label>
                                        <div class="col-sm-9" id="1">
                                            <input type="text" class="form-control" id="spectrum" placeholder="level2_quad_clean_Q0.pha">
                                        </div>
                                    </div>
                                    <% request.getSession().setAttribute("userId", "cztrspigen.jsp");%>
                                        
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Event file used in bindata</label>
                                        <div class="col-sm-9" id ="2">
                                            <input type="text" class="form-control" id="evtbindata" placeholder="level2_quad_clean.evt">
                                             
                                        </div>
                                    </div> 
                                    <div class="form-group row">
									<label for="fname" class="col-sm-3 text-right control-label col-form-label">Badpixel file name used in bindata</label>
						            <div class="col-sm-9" id="3">
						     <input type="text" class="form-control" id="badpixbindata" placeholder="level2_quad_badpix.fits">
						     <!-- <input type="file" name="fileInput" id="file"  onChange="FileDetails()" multiple="multiple"/> -->
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input Response file </label>
                                        <div class="col-sm-9" id="4">
                                            <input type="text" class="form-control" id="response" placeholder="level2_quad_clean_Q0.rsp">
                                        </div>
                                    </div>
