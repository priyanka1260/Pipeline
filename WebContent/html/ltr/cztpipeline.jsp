      ...
      -->                  <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Process Data </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                  			...
                  			<ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="cztgaas.jsp" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> cztgaas </span></a></li>
                                ...
                                <div class="card-body">
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="level1path" placeholder="level1 directory path">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Path create level 2 </label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="level2path" placeholder="level2 create file path">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Enter start stage</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="stage1" placeholder="1 or 3">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Enter end stage</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="stage2" placeholder="1 or 3">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Enter RA of source</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="RA" placeholder="RA">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Enter DEC of source</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="DEC" placeholder="DEC">
                                        </div>
                                    </div>
                              <div class="form-group row">
