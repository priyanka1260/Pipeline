...
var outputfile=document.getElementById("outputfile").value;
 ...
 if  (eventfile==null || eventfile=="",temperature==null || temperature=="",outputfile==null || outputfile=="")
		 {
 ...
 function serverFileOpen(checkboxName)
 {
     ...
     for (var i=0; i<checkboxes.length; i++) 
     {
         if (checkboxes[i].checked) 
         {
              ...
              if ((fname.indexOf("level2_bc.fits") !== -1   ) || (fname.indexOf("SS_level2.fits") !== -1))
            	  {
              				...
              				if(fname.indexOf("level2_bc.fits") !== -1  )
         		 				...
         		 				if(fname.indexOf("SS_level2.fits") !== -1)
     					 		{
         	 						
         	 					document.getElementById("temperature").value=fname;
     	 										}
                  }
              	else
            	  {
...
//var url="/Pipeline/cztpha2energy?&submit="+submit; 
			 ...
			 if(serverClick == "true")
				{
					...
					var url="/Pipeline/cztpha2energy?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
				}else{
					
					var url="/Pipeline/cztpha2energy?&localClicked="+localClicked+"&serverClick="+serverClick; 
					//var url="/Pipeline/cztbunchclean?&localClicked="+localClicked; 
				}
			  
			//var url="/Pipeline/cztpha2energy?&localClicked="+localClicked+"&serverClicked="+serverClicked;  
...
function display()
{
    ...
    if (req.readyState == 4 && req.status == 200)
    {
        ...
        if (flag == 0)
        	{
        $('#link').show();
        alert("CZTPHA2ENERGY COMPLETED SUCCESSFULLY");
        	}
        else
        	{
        	alert(err);
...
function processModule()
{
	...
	if (msg == "cztpha2energy.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
	...
	<%-- var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztpha2energy...!")
	 {
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 3-CZTPHA2ENERGY </h4>
                                   ...
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row"  >
                                        ...
                                        <div class="col-sm-9" id="1">
                                            <input type="text" class="form-control" id="eventfile" placeholder="level2_bc.fits" disable>
                                        </div>
                                    </div>
                                    <div class="form-group row" >
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Name of file with temp(ModeSS) </label>
                                        <div class="col-sm-9" id="2">
                                            <input type="text" class="form-control" id="temperature" placeholder="ss_level2.fits" disable>
                                    ...
                                    <% request.getSession().setAttribute("userId", "cztpha2energy.jsp");%>
                                    <div class="form-group row" >
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output file</label>
                                        <div class="col-sm-9" id="3">
                                            <input type="text" class="form-control" id="outputfile" placeholder="level2_bc.evt">
                                        </div>
                                    </div>                                                                 
                                            <div class="form-group row">
