...
var attitudemkffile=document.getElementById("attitudemkffile").value;
var badpixfile=document.getElementById("badpixfile").value;
var livetimefile=document.getElementById("livetimefile").value;
var outputfile=document.getElementById("outputfile").value;
var maskweightfile=document.getElementById("maskweightfile").value;
  

if  (eventfile==null || eventfile=="",attitudemkffile==null || attitudemkffile=="",badpixfile==null || badpixfile=="",livetimefile==null || livetimefile=="",outputfile==null || outputfile=="",maskweightfile==null || maskweightfile=="")
{
	...
	if (maskweightfile==null || maskweightfile=="")
    {
    	document.getElementById("6").classList.toggle("has-error");
	...
	document.getElementById("6").classList.toggle("has-success");
}
var m = document.getElementById("weight").selectedIndex;
var weight=(document.getElementsByTagName("option")[m].value);
//alert(weight);
...
var badthreshold=document.getElementById("badthreshold").value;


var n = document.getElementById("type").selectedIndex;
var type=(document.getElementById("type").getElementsByTagName("option")[n].value);


//alert(type);

var timebin=document.getElementById("timebin").value;

var energyrange=document.getElementById("energyrange").value;
...
//alert(expires);
 document.cookie = "outputfile="+ outputfile+ ";" + expires + ";path=/";
 document.cookie = "maskweightfile="+maskweightfile+";" + expires + ";path=/";
 document.cookie = "weight="+weight+";" + expires + ";path=/";
 document.cookie = "RA="+RA+";" + expires + ";path=/";
 document.cookie = "DEC="+DEC+";" + expires + ";path=/";
 document.cookie = "badthreshold="+badthreshold+";" + expires + ";path=/";
 document.cookie = "type="+type+";" + expires + ";path=/";
 document.cookie = "timebin="+timebin+";" + expires + ";path=/";
 document.cookie = "energyrange="+energyrange+";" + expires + ";path=/";
 ...
 function serverFileOpen(checkboxName)
 {
	 ...
	 //window.localStorage.setItem('serverClicked', true);
	  //serverClicked = "true";
     ...
     for (var i=0; i<checkboxes.length; i++) 
     {
         if (checkboxes[i].checked) 
         {
              ...
              if ((fname.indexOf("level2_quad_clean.evt") !== -1) || (fname.indexOf("level2.mkf") !== -1)|| (fname.indexOf("level2_quad_badpix.fits") !== -1) || (fname.indexOf("level2_quad_livetime.fits") !== -1))
            	  {
            	  

            	  if(fname.indexOf("level2_quad_clean.evt") !== -1)
             	 {
             	 document.getElementById("eventfile").value=fname;
             	 }
              if(fname.indexOf("level2.mkf") !== -1)
         	 {
             	 document.getElementById("attitudemkffile").value=fname;
         	 }
              if(fname.indexOf("level2_quad_badpix.fits") !== -1)
         	 {
             	 document.getElementById("badpixfile").value=fname;
         	 }
              if(fname.indexOf("level2_quad_livetime.fits") !== -1)
         	 {
             	 document.getElementById("livetimefile").value=fname;
         	 }
                  }
              	else
            	  {
			 ...
			 if(serverClick == "true")
				{
					...
					var url="/Pipeline/cztbindata?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
				}else{
					
					var url="/Pipeline/cztbindata?&localClicked="+localClicked+"&serverClick="+serverClick; 
					//var url="/Pipeline/cztbunchclean?&localClicked="+localClicked; 
				}
//var url="/Pipeline/cztbindata?&submit="+submit;
...
function display()
{
    ...
    if (req.readyState == 4 && req.status == 200)
    {
        ...
        //window.localStorage.removeItem('localClick');
        //window.localStorage.removeItem('serverClicked');
        alert("cztbindata COMPLETED SUCCESSFULLY");
...
function processModule()
{
	...
	if (msg == "cztbindata.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
	...
	<%-- var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztbindata...!")
	 {
...
function clear()
{
	...
	document.getElementById("attitudemkffile").value="";
document.getElementById("badpixfile").value="";
	document.getElementById("livetimefile").value="";
	document.getElementById("outputfile").value="";
	document.getElementById("maskweightfile").value="";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 12-CZTBINDATA </h4>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                                ...
                                <div class="card-body">
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="eventfile" placeholder="level2_quad_clean.evt" disabled>
                                        </div>
                                    </div>
                                     <% request.getSession().setAttribute("userId", "cztbindata.jsp");%>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">MKF file </label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="attitudemkffile" placeholder="level2.mkf" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input badpixel file</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="badpixfile" placeholder="quad_badpix.fits" disabled>
                                        </div>
                                    </div>   
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input livetime file</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="livetimefile" placeholder="level2_quad_livetime.fits" disabled>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output file</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="outputfile" placeholder="level2_quad_clean">
                                        </div>
                                    </div>    
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output event file with mask weight</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="maskweightfile" placeholder="level2_quad_clean_weight.evt">
                                        </div>
                                    </div>  
                                         <div class="form-group row">
									<label for="fname" class="col-sm-3 text-right control-label col-form-label">Apply mask weights</label>
						            <div class="col-sm-9">
						                    <select id="weight">
						  ...
						  <option value="n">No</option>
                                     ...
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Enter RA of source in decimal degrees</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="RA" placeholder="<0 - 360>">
                                        </div>
                                    </div>   
                                          <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Enter DEC of source in decimal degrees</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="DEC" placeholder="<-90 - 90>">
                                        </div>
                                    </div>     
                                       <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Badpixel threshold to be applied</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="badthreshold" placeholder="0">
                                        </div>
                                    </div>
                                         <div class="form-group row">
									<label for="fname" class="col-sm-3 text-right control-label col-form-label">Output type</label>
						            <div class="col-sm-9">
						  ...
						  <option value="spec">spec</option>
						   <option value="both">both</option>
												 ...
												 <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Time bin size for lc</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="timebin" placeholder="1000">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Enter energy range (in keV)</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="energyrange" placeholder="-">
                                        </div>
                                    </div>                                                    
                                                    <div class="form-group row">
...
<!--                                     <div  id="loading2" style="display:none;"><img src="../../assets/images/loading.gif" alt="" />Loading!</div>
     ...
     <%-- <input type="button" value="Download" class="btn btn-success"  onClick="<%=request.getContextPath()%>/download"> --%>
		  							<button type="button"  value="Reset" class="btn btn-primary" onClick="clear()">Reset</button>
		  							 <button type="button" id="Button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">V
