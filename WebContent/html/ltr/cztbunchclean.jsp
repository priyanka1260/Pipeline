...
var eventfile=document.getElementById("eventfile").value;
	 var bunchfile=document.getElementById("bunchfile").value;
	    ...
	    var bdeftime=document.getElementById("bdeftime").value;
	    var threshold=document.getElementById("threshold").value;
	    var livetime=document.getElementById("livetime").value;
	    if  (eventfile==null || eventfile=="",bunchfile==null || bunchfile=="",outputfile==null || outputfile=="",livetimefile==null || livetimefile=="",bdeftime==null || bdeftime=="",threshold==null || threshold=="",livetime==null || livetime=="")
		 {
	 ...
	 //alert(expires);
	  ...
	  document.cookie = "livetimefile="+livetimefile+";" + expires + ";path=/";
	  document.cookie = "bdeftime="+bdeftime+";" + expires + ";path=/";
	  document.cookie = "threshold="+threshold+";" + expires + ";path=/";
	  document.cookie = "livetime="+livetime+";" + expires + ";path=/";
 ...
 function serverFileOpen(checkboxName)
 {
     ...
     for (var i=0; i<checkboxes.length; i++) 
     {
         if (checkboxes[i].checked) 
         {
              ...
              if ((fname.indexOf("level2.fits") !== -1   ) || (fname.indexOf("level2_bunch.fits") !== -1))
            	  {
            	  

              				if(fname.indexOf("level2.fits") !== -1  )
         	 					{
         	 									
         	 						document.getElementById("eventfile").value=fname;
         	 							}
              
         		 				if(fname.indexOf("level2_bunch.fits") !== -1)
     					 		{
         	 						
         	 					document.getElementById("bunchfile").value=fname;
     	 										}
                  }
              	else
            	  {
 ...
 function FileDetails() {
     ...
     if (fi.files.length > 0) {
         ...
         for (var i = 0; i <= fi.files.length - 1; i++) {
             ...
             if(fname.indexOf("level2.fits") !== -1)
            	 {
            	 //request.getSession().setAttribute("evtfile", fname);
            	 document.getElementById("eventfile").value=fname;
            	 }
             if(fname.indexOf("level2_bunch.fits") !== -1)
        	 {
            	 //request.getSession().setAttribute("bunchfile", fname);
            	 document.getElementById("bunchfile").value=fname;
        	 }
         }
     }
...
function validation()
{
	...
	<%-- var localClick="<%=(String)request.getAttribute("localClick")%>";
	alert(localClick)
	
	if (localClick != null && localClick != "" && localClick !='null')
	{
		
		localClick= "false"
	} --%>
	//var submit="submit...!";
	//var localClicked=window.localStorage.getItem('localClicked');
	//var serverClicked=window.localStorage.getItem('serverClicked');
	 ...
	 if(serverClick == "true")
		{
			...
			var url="/Pipeline/cztbunchclean?&localClicked="+"false"+"&serverClick="+serverClick; 
		 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
		}else{
			
			var url="/Pipeline/cztbunchclean?&localClicked="+localClicked+"&serverClick="+serverClick; 
...
function processModule()
{
	...
	if (msg == "cztbunchclean.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
	...
	document.getElementById("eventfile").value="";
	 document.getElementById("bunchfile").value="";
	  ...
	  document.getElementById("livetimefile").value="";
	   document.getElementById("bdeftime").value="";
...
<!--                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="charts.html" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Charts</span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 2-CZTBUNCHCLEAN </h4>
                                   ...
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9" id="1">
                                            <input type="text" class="form-control" name="eventfile" id="eventfile" placeholder="level2.fits" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Bunch file </label>
                                        <div class="col-sm-9" id="2">
                                            <input type="text" class="form-control" id="bunchfile" name="bunchfile" placeholder="level2_bunch.fits" disabled>
                                          <!--  <button type="button" id="browse" class="btn btn-primary browse"> <i class="fas fa-desktop"></i></button> -->
											<!-- <input  type='file' id="file"  onChange="FileDetails()" multiple="multiple"  /><br>
                                            -->
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <% request.getSession().setAttribute("userId", "cztbunchclean.jsp");%>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output file</label>
                                        <div class="col-sm-9" id ="3">
                                            <input type="text" class="form-control" id="outputfile" placeholder="level2_bc.fits" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Output livetimme file</label>
                                        <div class="col-sm-9" id ="4">
                                            <input type="text" class="form-control" id="livetimefile" placeholder="level2_bc_livetime.fits" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Bunch definition time</label>
                                        <div class="col-sm-9" id="5">
                                            <input type="number" class="form-control" id="bdeftime" placeholder="30 us" required>
                                        </div>
                                    </div>  
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Bunch length threshold</label>
                                        <div class="col-sm-9" id="6">
                                            <input type="number" class="form-control" id="threshold" placeholder="20" required>
                                        </div>
                                    </div>  
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Binsize livetime calculation</label>
                                        <div class="col-sm-9" id="7">
                                            <input type="number" class="form-control" id="livetime" placeholder="1 sec" required>
                                        </div>
                                    </div>                                 
                              <div class="form-group row">
     ...
     <%-- <input type="button" value="Download" class="btn btn-success"  onClick="<%=request.getContextPath()%>/download"> --%>
		  							<button type="button"  name="button" value="Reset" class="btn btn-primary" onClick="clear()">Reset</button>
