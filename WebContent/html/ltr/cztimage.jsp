...
var aspectQ0=document.getElementById("aspectQ0").value;
var aspectQ1=document.getElementById("aspectQ1").value;
var aspectQ2=document.getElementById("aspectQ2").value;
var aspectQ3=document.getElementById("aspectQ3").value;
var outputfile=document.getElementById("outpufile").value;
var quadrant=document.getElementById("quadrant").value;

if  (inputtype==null || inputtype=="",inputfile==null || inputfile=="",aspectQ0==null || aspectQ0=="",aspectQ1==null || aspectQ1=="",aspectQ2==null || aspectQ2=="",aspectQ3==null || aspectQ3=="",outputfile==null || outputfile=="",,quadrant==null || quadrant=="")
{
...
return false
	...
	(
		...
		//alert(expires);
		 document.cookie = "inputtype="+ inputtype+ ";" + expires + ";path=/";
		 document.cookie = "outputfile="+outputfile+";" + expires + ";path=/";
		 document.cookie = "quadrant="+quadrant+";" + expires + ";path=/";
  ...
  function serverFileOpen(checkboxName)
  {
      ...
      for (var i=0; i<checkboxes.length; i++) 
      {
          if (checkboxes[i].checked) 
          {
               ...
               if (fname.indexOf("level2_quad_clean.dpi") !== -1 || (fname.indexOf("level2.aspect_Q0") !== -1) || (fname.indexOf("level2.aspect_Q1") !== -1) ||(fname.indexOf("level2.aspect_Q2") !== -1) || (fname.indexOf("level2.aspect_Q3") !== -1))
             	  {
             	  

            	   if(fname.indexOf("level2_quad_clean.dpi") !== -1)
              	 {
              	 document.getElementById("inputfile").value=fname;
              	 }
               if(fname.indexOf("level2.aspect_Q0") !== -1)
          	 {
              	 document.getElementById("aspectQ0").value=fname;
          	 }
               if(fname.indexOf("level2.aspect_Q1") !== -1)
          	 {
              	 document.getElementById("aspectQ1").value=fname;
          	 }
               if(fname.indexOf("level2.aspect_Q2") !== -1)
          	 {
              	 document.getElementById("aspectQ2").value=fname;
          	 }
               if(fname.indexOf("level2.aspect_Q3") !== -1)
          	 {
              	 document.getElementById("aspectQ3").value=fname;
          	 }
                   }
               	else
             	  {
...
function validation()
{
	$('#loading2').show();
	//var submit="submit...!";
/* ar inputtype=document.getElementById("inputtype").value;
var inputfile=document.getElementById("inputfile").value;
var aspectQ0=document.getElementById("aspectQ0").value;
var aspectQ1=document.getElementById("aspectQ1").value;
var aspectQ2=document.getElementById("aspectQ2").value;
...
//var url="/Pipeline/cztimage?&submit="+submit; 
			 ...
			 if(serverClick == "true")
				{
					...
					var url="/Pipeline/cztimage?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
				}else{
					
					var url="/Pipeline/cztimage?&localClicked="+localClicked+"&serverClick="+serverClick; 
...
function display()
{
    ...
    if (req.readyState == 4 && req.status == 200)
    {
        ...
        alert("CZTIMAGE COMPLETED SUCCESSFULLY");
...
function processModule()
{
	...
	if (msg == "cztimage.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
	...
	<%-- var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztimage...!")
	 {
...
function clear()
{
	...
	document.getElementById("aspectQ0").value="";
	document.getElementById("aspectQ1").value="";
	document.getElementById("aspectQ2").value="";
	document.getElementById("aspectQ3").value="";
}
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 11-CZTIMAGE </h4>
                                ...
                                <div class="card-body">
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Input type</label>
                                        <div class="col-sm-9" id="1">
                                            <input type="text" class="form-control" id="inputtype" placeholder="dpi or dph">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input file </label>
                                        <div class="col-sm-9" id="2">
                                            <input type="text" class="form-control" id="inputfile" placeholder="level2_quad_clean.dpi" disabled>
                                        </div>
                                    </div>
<!--                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Shadow file</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" placeholder="level2.shadow">
                                        </div>
                                    </div>  -->  
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input aspect file Q0</label>
                                        <div class="col-sm-9" id="3">
                                            <input type="text" class="form-control" id="aspectQ0" placeholder="level2.aspect_Q0" disabled>
                                        </div>
                                    </div>    
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input aspect file Q1</label>
                                        <div class="col-sm-9" id="4">
                                            <input type="text" class="form-control" id="aspectQ1" placeholder="level2.aspect_Q1" disabled>
                                        </div>
                                    </div>    
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input aspect file Q2</label>
                                        <div class="col-sm-9" id="5">
                                            <input type="text" class="form-control" id="aspectQ2" placeholder="level2.aspect_Q2" disabled>
                                        </div>
                                    </div>    
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input aspect file Q3</label>
                                        <div class="col-sm-9" id="6">
                                            <input type="text" class="form-control" id="aspectQ3" placeholder="level2.aspect_Q3" disabled>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <% request.getSession().setAttribute("userId", "cztimage.jsp");%>   
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output file</label>
                                        <div class="col-sm-9" id="7">
                                            <input type="text" class="form-control" id="outpufile" placeholder="level2_quad_clean.img">
                                        </div>
                                    </div> 
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Enter quadrant</label>
                                        <div class="col-sm-9" id="8">
                                            <input type="text" class="form-control" id="quadrant" placeholder="0 or 1 or 2 or 3">
                                        </div>
                                    </div>                                                              
                                        <div class="form-group row">
