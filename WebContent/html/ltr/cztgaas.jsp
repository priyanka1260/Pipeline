...
var mkffile=document.getElementById("mkffile").value;
  ...
  if  (eventfile==null || eventfile=="",mkffile==null || mkffile=="",outputaspect==null || outputaspect=="")
	  {
	  ...
	  if (outputaspect==null || outputaspect=="")
      {
...
//alert(expires);
 ...
 document.cookie = "outputaspect="+outputaspect+";" + expires + ";path=/";
	 ...
	 window.localStorage.setItem('serverClick', "true");
      ...
      for (var i=0; i<checkboxes.length; i++) 
      {
          if (checkboxes[i].checked) 
          {
               ...
               if ((fname.indexOf("level2_bc.fits") !== -1   ) || (fname.indexOf("level2.mkf") !== -1))
             	  {
...
//var url="/Pipeline/cztgaas?&submit="+submit;
			 ...
			 if(serverClick == "true")
				{
					...
					var url="/Pipeline/cztgaas?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
				}else{
					
					var url="/Pipeline/cztgaas?&localClicked="+localClicked+"&serverClick="+serverClick; 
					//var url="/Pipeline/cztbunchclean?&localClicked="+localClicked; 
				}

			//var url="/Pipeline/cztgaas?&localClicked="+localClicked+"&serverClicked="+serverClicked; 
...
function display()
{
	...
	if (req.readyState == 4 && req.status == 200)
    {
        ...
        if (flag == 0)
        	{
        $('#link').show();
        alert("CZTGASS COMPLETED SUCCESSFULLY");
        	}
        else
        	{
        	alert(err);
...
function processModule()
{
	...
	if (msg == "cztgaas.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
...
<%-- 	var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztgaas...!")
	 {
...
function clear()
{
	 ...
	 document.getElementById("eventfile").value="";
	document.getElementById("mkffile").value="";
	document.getElementById("outputaspect").value="";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 5-CZTGAAS </h4>
                            ...
                            <form class="form-horizontal" name="form1" action="/Pipeline/html/ltr/uplod.jsp" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    ...
                                    <% request.getSession().setAttribute("userId", "cztgaas.jsp");%>
                                    <div class="form-group row" >
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">MKF file </label>
                                        <div class="col-sm-9" id="2">
                                            <input type="text" class="form-control" id="mkffile" placeholder="level2.mkf" disable>
                                    ...
                                    <div class="form-group row" >
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output aspect file</label>
                                        <div class="col-sm-9" id="3">
                                            <input type="text" class="form-control" id="outputaspect" placeholder="level2.aspect">
                                        </div>
                                    </div>                                                                 
						             <div class="form-group row">
