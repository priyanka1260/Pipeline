...
var gtitype=document.getElementById("gtitype").value;
var outputfile=document.getElementById("outputfile").value;
  
if  (eventfile==null || eventfile=="",gtifile==null || gtifile=="",gtitype==null || gtitype=="",outputfile==null || outputfile=="")
	{
...
//alert(expires);
 ...
 document.cookie = "gtitype="+gtitype+";" + expires + ";path=/";
 ...
 function serverFileOpen(checkboxName)
 {
     ...
     for (var i=0; i<checkboxes.length; i++) 
     {
         if (checkboxes[i].checked) 
         {
              ...
              if ((fname.indexOf("level2_bc.fits") !== -1   ) || (fname.indexOf("level2.gti") !== -1))
            	  {
            	  

              				if(fname.indexOf("level2_bc.fits") !== -1  )
         	 					{
         	 									
         	 						document.getElementById("eventfile").value=fname;
         	 							}
              
         		 				if(fname.indexOf("level2.gti") !== -1)
     					 		{
         	 						
         	 					document.getElementById("gtifile").value=fname;
     	 										}
                  }
              	else
            	  {
...
//var url="/Pipeline/cztdatasel?&submit="+submit;  
			
			 <%-- var localClicked = "<%=(String) request.getSession().getAttribute("localClicked")%>"; 
			  
			  alert("inside validation");

			var url="/Pipeline/cztdatasel?&localClicked="+localClicked;  --%>
			 ...
			 if(serverClick == "true")
				{
					...
					var url="/Pipeline/cztdatasel?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
				}else{
					
					var url="/Pipeline/cztdatasel?&localClicked="+localClicked+"&serverClick="+serverClick; 
...
function processModule()
{
	...
	if (msg == "cztdatasel.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
	...
	<%-- var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztdatasel...!")
	 {
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 6-CZTDATASEL </h4>
                                   ...
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9" id="1">
                                            <input type="text" class="form-control" id="eventfile" placeholder="level2_bc.fits" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input GTI file </label>
                                        <div class="col-sm-9" id="2">
                                            <input type="text" class="form-control" id="gtifile" placeholder="level2.gti" disabled>
                                    ...
                                    <% request.getSession().setAttribute("userId", "cztdatasel.jsp");%>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">GTI type</label>
                                        <div class="col-sm-9" id="3">
                                            <input type="text" class="form-control" id="gtitype" placeholder="Quad or Common">
                                        </div>
                                    </div>             
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output file</label>
                                        <div class="col-sm-9" id="4">
                                            <input type="text" class="form-control" id="outputfile" placeholder="level2_GTITYPE_bc_ds.evt">
                                        </div>
                                    </div>                                                    
                                      <div class="form-group row">
