...
var badpixelfile=document.getElementById("badpixelfile").value;
   var badthreshold=document.getElementById("badthreshold").value;
var outdphfile=document.getElementById("outdphfile").value;
var outdpifile=document.getElementById("outdpifile").value;
var quadrant=document.getElementById("quadrant").value;
var energybin=document.getElementById("energybin").value;
var timebin=document.getElementById("timebin").value;
if  (eventfile==null || eventfile=="",badpixelfile==null || badpixelfile=="",badthreshold==null || badthreshold=="",outdphfile==null || outdphfile=="",outdpifile==null || outdpifile=="",quadrant==null || quadrant=="",energybin==null || energybin=="",timebin==null || timebin=="")
{
...
return false
	...
	document.getElementById("7").classList.toggle("has-success");
	document.getElementById("8").classList.toggle("has-success");
...
//alert(expires);
 ...
 document.cookie = "outdphfile="+outdphfile+";" + expires + ";path=/";
 document.cookie = "outdpifile="+outdpifile+";" + expires + ";path=/";
 document.cookie = "quadrant="+quadrant+";" + expires + ";path=/";
 document.cookie = "energybin="+energybin+";" + expires + ";path=/";
	 ...
	 window.localStorage.setItem('serverClick', "true");
      ...
      for (var i=0; i<checkboxes.length; i++) 
      {
          if (checkboxes[i].checked) 
          {
               ...
               if ((fname.indexOf("level2_quad_clean.evt") !== -1   ) || (fname.indexOf("level2_quad_badpix.fits") !== -1))
             	  {
               				...
               				if(fname.indexOf("level2_quad_clean.evt") !== -1  )
          	 					...
          	 					document.getElementById("badpixelfile").value=fname;
      	 										}
                   }
               	else
             	  {
...
function validation()
{
	 $('#loading2').show();
	// var submit="submit...!";
/* ar eventfile=document.getElementById("eventfile").value;
var badpixelfile=document.getElementById("badpixelfile").value;
var badthreshold=document.getElementById("badthreshold").value;
var outdphfile=document.getElementById("outdphfile").value;
var outdpifile=document.getElementById("outdpifile").value;
...
alert(values);
	...
	if(serverClick == "true")
	{
		...
		var url="/Pipeline/cztdpigen?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
	}else{
					
	var url="/Pipeline/cztdpigen?&localClicked="+localClicked+"&serverClick="+serverClick; 
					//var url="/Pipeline/cztbunchclean?&localClicked="+localClicked; 
	}		
	//var url="/Pipeline/cztdpigen?&localClicked="+localClicked+"&serverClicked="+serverClicked; 

//var url="/Pipeline/cztdpigen?&submit="+submit;
...
function display()
{
    ...
    if (req.readyState == 4 && req.status == 200)
    {
        ...
        if (flag == 0)
        	{
        $('#link').show();
        alert("cztbunchclean COMPLETED SUCCESSFULLY");
        	}
        else
        	{
        	alert(err);
    ...
    i/* f (req.readyState == 4 && req.status == 200)
    {
...
function processModule()
{
	...
	if (msg == "cztdpigen.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
	 {
...
<%-- 	var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztdpigen...!")
	 {
...
function clear()
{
	...
	document.getElementById("eventfile").value="";
	document.getElementById("badpixelfile").value="";
	   document.getElementById("badthreshold").value="";
	document.getElementById("outdphfile").value="";
	document.getElementById("outdpifile").value="";
	document.getElementById("quadrant").value="";
	document.getElementById("energybin").value="";
	document.getElementById("timebin").value="";
}
</script> 
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 10-CZTDPIGEN </h4>
                                   ...
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9" id="2">
                                            <input type="text" class="form-control" id="badpixelfile" placeholder="level2_quad_badpix.fits" disabled>
                                    ...
                                    <% request.getSession().setAttribute("userId", "cztdpigen.jsp");%>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Badpixel threshold</label>
                                        <div class="col-sm-9" id="3">
                                            <input type="number" class="form-control" id="badthreshold" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Output DPH file</label>
                                        <div class="col-sm-9 id="4"">
                                            <input type="text" class="form-control" id="outdphfile" placeholder="level2_quad_clean.dph">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Output DPI file</label>
                                        <div class="col-sm-9" id="5">
                                            <input type="text" class="form-control" id="outdpifile" placeholder="level2_quad_clean.dpi">
                                        </div>
                                    </div>    
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Quadrant numbers to be processed</label>
                                        <div class="col-sm-9" id="6">
                                            <input type="text" class="form-control" id="quadrant" placeholder="-">
                                        </div>
                                    </div>  
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Energy bins</label>
                                        <div class="col-sm-9" id="7">
                                            <input type="text" class="form-control" id="energybin" placeholder="-">
                                        </div>
                                    </div>  
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Time bins</label>
                                        <div class="col-sm-9" id="8">
                                            <input type="text" class="form-control" id="timebin" placeholder="-">
                                        </div>
                                    </div>                               
                                           <div class="form-group row">
