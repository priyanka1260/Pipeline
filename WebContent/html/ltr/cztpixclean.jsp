...
var livetimefile=document.getElementById("livetimefile").value;
   var singleevtfile=document.getElementById("singleevtfile").value;
var outlivetime=document.getElementById("outlivetime").value;
var outputbadpixel=document.getElementById("outputbadpixel").value;
var bindetector=document.getElementById("bindetector").value;
var binpixel=document.getElementById("binpixel").value;
var thresholddetector=document.getElementById("thresholddetector").value;
var thresholdpixel=document.getElementById("thresholdpixel").value;

if  (eventfile==null || eventfile=="",singleevtfile==null || singleevtfile=="",outlivetime==null || outlivetime=="",livetimefile==null || livetimefile=="",outputbadpixel==null || outputbadpixel=="",bindetector==null || bindetector=="",binpixel==null || binpixel=="",thresholddetector==null || thresholddetector=="",thresholdpixel==null || thresholdpixel=="")
{
...
if (singleevtfile==null || singleevtfile=="")
{
...
if (outlivetime==null || outlivetime=="")
	{
	document.getElementById("5").classList.toggle("has-error");

  
	}
if(outputbadpixel==null || outputbadpixel=="")
	{
	document.getElementById("6").classList.toggle("has-error");

   
	}
if(bindetector==null || bindetector=="")
	{
	document.getElementById("7").classList.toggle("has-error");

  
	}
if(binpixel==null || binpixel=="")
{
document.getElementById("8").classList.toggle("has-error");


}
if(thresholddetector==null || thresholddetector=="")
{
document.getElementById("9").classList.toggle("has-error");


}
if(thresholdpixel==null || thresholdpixel=="")
{
document.getElementById("10").classList.toggle("has-error");
...
//alert(expires);
 document.cookie = "singleevtfile="+ singleevtfile+ ";" + expires + ";path=/";
 document.cookie = "outlivetime="+outlivetime+";" + expires + ";path=/";
 document.cookie = "outputbadpixel="+outputbadpixel+";" + expires + ";path=/";
 document.cookie = "bindetector="+bindetector+";" + expires + ";path=/";
 document.cookie = "binpixel="+binpixel+";" + expires + ";path=/";
 document.cookie = "thresholddetector="+thresholddetector+";" + expires + ";path=/";
 document.cookie = "thresholdpixel="+thresholdpixel+";" + expires + ";path=/";
 ...
 function serverFileOpen(checkboxName)
 {
     ...
     for (var i=0; i<checkboxes.length; i++) 
     {
         if (checkboxes[i].checked) 
         {
              ...
              if ((fname.indexOf("level2_quad_bc_ds.evt") !== -1   ) || (fname.indexOf("level2_common_bc_ds.evt") !== -1)|| (fname.indexOf("level2_bc_livetime.fits") !== -1))
            	  {
            	  

            	  if((fname.indexOf("level2_quad_bc_ds.evt") !== -1) || (fname.indexOf("level2_common_bc_ds.evt") !== -1))
         	 					{
         	 									
         	 						document.getElementById("eventfile").value=fname;
         	 							}
              
         		 				if(fname.indexOf("level2_bc_livetime.fits") !== -1)
     					 		{
...
//var url="/Pipeline/cztpixclean?&submit="+submit; 
			 ...
			 if(serverClick == "true")
				{
					...
					var url="/Pipeline/cztpixclean?&localClicked="+"false"+"&serverClick="+serverClick; 
				 //var url="/Pipeline/cztbunchclean?&serverClick="+serverClick; 
				}else{
					
					var url="/Pipeline/cztpixclean?&localClicked="+localClicked+"&serverClick="+serverClick; 
					//var url="/Pipeline/cztbunchclean?&localClicked="+localClicked; 
				}
			//var url="/Pipeline/cztpixclean?&localClicked="+localClicked+"&serverClicked="+serverClicked; 
...
function display()
{
	...
	if (req.readyState == 4 && req.status == 200)
    {
        ...
        if (flag == 0)
        	{
        $('#link').show();
        alert("cztpixclean COMPLETED SUCCESSFULLY");
        	}
        else
        	{
        	alert(err);
...
function processModule()
{
	<%-- var msg=null;
	 ...
	 if (msg == "File Successfully Uploaded for cztpixclean...!")
	 {
	 ...
	 document.getElementById("Button").disabled = true;
		...
		if (msg == "cztpixclean.jsp")/* & (eventfile!=null || eventfile!="",bunchfile!=null || bunchfile!="",outputfile!=null || outputfile!="",livetimefile!=null || livetimefile!="",bdeftime!=null || bdeftime!="",threshold!=null || threshold!="",livetime!=null || livetime!="") */
		 {
...
function clear()
{
	...
	document.getElementById("livetimefile").value="";
	   document.getElementById("singleevtfile").value="";
document.getElementById("outlivetime").value="";
	document.getElementById("outputbadpixel").value="";
	document.getElementById("bindetector").value="";
	document.getElementById("binpixel").value="";
	document.getElementById("thresholddetector").value="";
document.getElementById("thresholdpixel").value="";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Module 7-CZTPIXCLEAN </h4>
                                   ...
                                   <!--  <h4 class="card-title">Personal Info</h4> -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9" id="1">
                                            <input type="text" class="form-control" id="eventfile" placeholder="level2_GTITYPE_bc_ds.evt" disable>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Input livetime file </label>
                                        <div class="col-sm-9" id="2">
                                            <input type="text" class="form-control" id="livetimefile" placeholder="level2_bc_livetime.fits" disable>
                                    ...
                                    <% request.getSession().setAttribute("userId", "cztpixclean.jsp");%>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Output single event file</label>
                                        <div class="col-sm-9" id="3">
                                            <input type="text" class="form-control" id="singleevtfile" placeholder="level2_GTITYPE_bs_ds_pc.evt">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Output livetime file</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="outlivetime" placeholder="level2_GTITYPE_livetime.fits">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Output badpixel file</label>
                                        <div class="col-sm-9" id="3">
                                            <input type="text" class="form-control" id="outputbadpixel" placeholder="level2_GTITYPE_badpix.fits">
                                        </div>
                                    </div>  
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Time bin of dector lightcurve</label>
                                        <div class="col-sm-9" id="4">
                                            <input type="number" class="form-control" id="bindetector" placeholder="1 sec">
                                        </div>
                                    </div>  
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Time bin for pixel lightcurve</label>
                                        <div class="col-sm-9" id="5">
                                            <input type="number" class="form-control" id="binpixel" placeholder="1 sec">
                                        </div>
                                    </div> 
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Count threshold for detector</label>
                                        <div class="col-sm-9" id="6">
                                            <input type="number" class="form-control" id="thresholddetector" placeholder="25">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Count threshold for pixel</label>
                                        <div class="col-sm-9" id="7">
                                            <input type="number" class="form-control" id="thresholdpixel" placeholder="2">
                                        </div>
                                    </div>                                
                                                                              <div class="form-group row">
